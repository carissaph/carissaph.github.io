...
- Built **Decision Tree and Random Forest models** with Python, TensorFlow, and geospatial libraries.
...
- Performed **clustering analysis** on **10,000+** energy consumption records combined with 25 socioeconomic factors.
- Designed **decision trees** from **1,000+** consumer questionnaires to identify behavioral drivers and validate assumptions.
